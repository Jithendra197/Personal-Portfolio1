...
const About = () => {
    return (
        <div className="bg-gray-800 w-full text-white min-h-screen py-18" id="/about">
            <div className="container mx-auto px-8 sm:8 md:px-16 lg:px-24">
                <h2 className="text-5xl py-4 font-bold text-center mb-3 bg-white bg-clip-text text-transparent">About Me</h2>
                    ...
                    <div className="flex-1 md:flex md:flex-col">
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col md:flex md:items-center gap-2">
                                ...
                                <div className=" bg-black rounded-full w-60 md:w-130 h-2.5 lg:w-160 hover:scale-102 duration-300">
