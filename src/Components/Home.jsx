...
const Home =() => {
    return(
        <div className="bg-gray-800 w-full text-white min-h-screen min-w-screen py-2 text-center" id="/">
          <div className="pt-13">
            <img className="  w-40  md:w-50 h-55 mb-6 pt-5 mx-auto objects-cover rounded-full transition-transform duration-600 hover:scale-110" src={image} alt=""></img>
                <h1 className="text-4xl lg:text-6xl font-bold px-10 md:px-6 py-2 ">Hi, I'm <span className="bg-gradient-to-r from-blue-700 via-yellow-500 to-green-700 text-transparent bg-clip-text inline-block py-2">Jithendra Nagaraj Jalihal,</span><br/> a frontend developer based in India.</h1>
