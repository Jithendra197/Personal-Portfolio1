...
const Education = () => {
    return(
        <div className="bg-gray-800 min-w-screen text-white min-h-screen py-16"id="/education">
            <div className="container">
                <h1 className="text-center text-5xl py-4 font-bold bg-white bg-clip-text text-transparent">Education</h1>
            </div>
